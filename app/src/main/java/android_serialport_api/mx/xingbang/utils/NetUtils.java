...
public class NetUtils {
    ...
    public static void openSetting(final Activity activity) {
        ...
        builder.setTitle(activity.getString(R.string.text_tip_network));//"开启网络服务"
        builder.setMessage(activity.getString(R.string.text_error_tip62));//网络没有连接，请到设置进行网络设置！
        builder.setPositiveButton(activity.getString(R.string.text_alert_sure),
        ...
        builder.setNegativeButton(activity.getString(R.string.text_alert_cancel),
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
    ...
    public static int getNetWorkStart(Context context) {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) context
                .getSystemService(Context.CONNECTIVITY_SERVICE); // 连接服务
...
//            Toast.makeText(context, "网络错误，请检查您的网络！", Toast.LENGTH_SHORT).show();
    ...
    public static boolean haveNetWork(Context context){
        // 如果有网络
        return NetUtils.getNetWorkStart(context) != NetUtils.NETWORK_NONE;
