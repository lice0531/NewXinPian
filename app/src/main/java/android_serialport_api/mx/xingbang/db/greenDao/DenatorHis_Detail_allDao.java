...
/** 
 * DAO for table "denatorHis_Detail_all".
*/
public class DenatorHis_Detail_allDao extends AbstractDao<DenatorHis_Detail_all, Long> {

    public static final String TABLENAME = "denatorHis_Detail_all";

    /**
     * Properties of entity DenatorHis_Detail_all.<br/>
    ...
    public DenatorHis_Detail_allDao(DaoConfig config) {
        super(config);
    }
    
    public DenatorHis_Detail_allDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"denatorHis_Detail_all\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"denatorHis_Detail_all\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DenatorHis_Detail_all entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DenatorHis_Detail_all entity) {
        stmt.clearBindings();
    ...
    @Override
    public DenatorHis_Detail_all readEntity(Cursor cursor, int offset) {
        DenatorHis_Detail_all entity = new DenatorHis_Detail_all( //
    ...
    @Override
    public void readEntity(Cursor cursor, DenatorHis_Detail_all entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DenatorHis_Detail_all entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DenatorHis_Detail_all entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DenatorHis_Detail_all entity) {
