...
//        });
    ...
    private void deleteRiZhi() {
        ...
        if (hasSDCard) {
            filePath = Environment.getExternalStorageDirectory().toString() + File.separator + "/MX程序运行日志/";
        } else {
            filePath = Environment.getDownloadCacheDirectory().toString() + File.separator + "/MX程序运行日志/";
        }
        if (hasSDCard) {
            filePath2 = Environment.getExternalStorageDirectory().toString() + File.separator + "/MX_XB程序日志/";
        } else {
            filePath2 = Environment.getDownloadCacheDirectory().toString() + File.separator + "/MX_XB程序日志/";
        }
