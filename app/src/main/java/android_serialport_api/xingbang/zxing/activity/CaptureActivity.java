package android_serialport_api.xingbang.zxing.activity;
...
import android_serialport_api.xingbang.zxing.decoding.CaptureActivityHandler;
import android_serialport_api.xingbang.zxing.decoding.InactivityTimer;
import android_serialport_api.xingbang.zxing.decoding.RGBLuminanceSource;
import android_serialport_api.xingbang.zxing.util.BitmapUtil;
import android_serialport_api.xingbang.zxing.util.Constant;
import android_serialport_api.xingbang.zxing.view.ViewfinderView;
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    private void handleAlbumPic(Intent data) {
        ...
        mProgress.setMessage(getResources().getString(R.string.text_zzsm));
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    Toast.makeText(CaptureActivity.this, getResources().getString(R.string.text_sbsb), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
