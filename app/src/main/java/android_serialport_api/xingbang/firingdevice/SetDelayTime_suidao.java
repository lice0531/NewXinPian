...
public class SetDelayTime_suidao extends BaseActivity {
        ...
        mHandler_0 = new Handler(msg -> {
            switch (msg.what) {
                ...
                case 1002:
                    ...
                    // 显示提示
                    show_Toast(getResources().getString(R.string.text_suidao_yxz) + b);
                    break;
                case 1005://按管壳码排序
                    mListData = new GreenDaoMaster().queryDetonatorRegionDesc(mRegion);
    ...
    private void getFactoryType() {
        ...
        if (deTypeSecond != null) {
            ...
            Log.e("隧道设置页面","数据库中获取到的最大延时为空，特设为最大延时150毫秒");
            maxSecond = 150;
        }
        Log.e("隧道设置页面最大延时", "maxSecond: " + maxSecond);
    }
    ...
    private void modifyBlastBaseInfo(int no, int delay, final String shellBlastNo) {
        ...
        builder.setPositiveButton(getResources().getString(R.string.text_alert_sure), (dialog, which) -> {
            ...
            if (maxSecond != 0 && Integer.parseInt(delay1) >= maxSecond) {
                ...
                show_Toast(shellBlastNo + getResources().getString(R.string.text_setDelay_show3));
...
//                    Log.e("判断数量是否为空20", "退出 ");
    ...
    private void setTitleRegion(String region, int size) {
        ...
        String str = getResources().getString(R.string.text_dfzc_qy) + region ;
        // 设置标题
