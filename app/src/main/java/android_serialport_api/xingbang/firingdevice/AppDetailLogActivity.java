...
public class AppDetailLogActivity extends BaseActivity {
    ...
    private void initData() {
            ...
            public void onButtonClicked(View v, int position) {
                switch (v.getId()) {
                    ...
                    case R.id.bt_upload:
                        ...
                        upload_xingbang(position,blastdate, htbh, jd, wd, xmbh, dwdm, qbxm_name, log, log_cmd);//我们自己的网址
                        break;
                }
            }
        ...
        mHandler_update = new Handler(msg -> {
            switch (msg.what) {
                case 1:
                    int pos = msg.arg1;
                    updateUpStateByDate(normalLogList.get(pos).getUpdataTime());
    ...
    // 更新指定日期的日志状态为“已上传”
    public void updateUpStateByDate(String dateTime) {
        new GreenDaoMaster().updateAppLog(dateTime);
...
//        Shangchuan = (String) MmkvUtils.getcode("Shangchuan","否");
    ...
    private void upload_xingbang(final int pos,String blastdate, final String htid, final String jd, final String wd, final String xmbh, final String dwdm, final String qbxm_name, final String log, final String log_cmd) {
