        ...
        switch (view.getId()) {
            ...
            case R.id.btn_del_all:
                AlertDialog dialog = new AlertDialog.Builder(this)
                        .setTitle(getResources().getString(R.string.text_delete_tip1))//设置对话框的标题//"成功起爆"
                        .setMessage(getResources().getString(R.string.text_delete_tip2))//设置对话框的内容"本次任务成功起爆！"
                        //设置对话框的按钮
                        ...
                        .setPositiveButton(getResources().getString(R.string.text_delete_tip4), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
