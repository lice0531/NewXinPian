...
//                setView(maxDuanNo);
    ...
    private void creatPai() {
        ...
        PaiData paimax = GreenDaoMaster.gePaiData(mRegion, paiMax+"");
        ...
        if (paiMax == 0) {
            ...
            startDelay.setText((Integer.parseInt(paimax.getStartDelay()) + Integer.parseInt(quYu_choice.getPaiDelay())) + "");
        }
