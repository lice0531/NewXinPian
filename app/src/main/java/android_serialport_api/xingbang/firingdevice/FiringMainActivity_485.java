...
public class FiringMainActivity_485 extends SerialPortActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firing_page_485);
...
//            busInfo = null;
    ...
    private void initParam() {
        FiringMainActivity_485.stage = 0;
        writeVo = null;
        firstWaitCount = 3;
        Wait_Count = 5;
        firstCmdReFlag = 0;
    ...
    public void disPlayNoReisterDenator(final int flag) {
        Builder builder = new Builder(FiringMainActivity_485.this);
...
//        cursor.close();
    ...
    public void createDialog() {
        LayoutInflater inflater = LayoutInflater.from(FiringMainActivity_485.this);
...
//            String chongdian = ThreeFiringCmd.getCheckFrom38(fromCommad);
            ...
            //说明打开电源命令成功
            if (FiringMainActivity_485.stage == 1) {
                firstCmdReFlag = 1;
            ...
            if (FiringMainActivity_485.stage == 8) {
                ...
                if (eightCmdFlag == 2) {
                    ...
                    AlertDialog dialog = new Builder(this)
                            ...
                            .setPositiveButton(getString(R.string.text_firing_tip17), new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent intent = new Intent(FiringMainActivity_485.this, QueryHisDetail.class);
