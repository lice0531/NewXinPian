 ...
 * 雷管信息页面 适配器
 */
public class DetonatorAdapter_Paper<T> extends RecyclerView.Adapter<DetonatorAdapter_Paper.ViewHolder> {
     ...
     *                5: 序号 孔号 延时 管壳号 状态
     */
    public DetonatorAdapter_Paper(Context context, int line) {
        mContext = context;
        mLine = line;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (mIndex == 1) {
            ...
            if(mLine == 6){
                ...
                holder.mTvSitHole.setText(detonatorBaseInfo.getDuanNo() + "");     // 段号
