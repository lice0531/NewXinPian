...
public class ErrDuanAdapter extends BaseAdapter {
    private ArrayList<Map<String, Object>> list;
    private Context mContext;
    private int itemListId;

    public ErrDuanAdapter(Context context, ArrayList<Map<String, Object>> list, int itemListId) {
        this.list = list;
...
//        viewHolder.X_item_no.setText((position + 1)+"");//雷管uid
        ...
        viewHolder.X_item_delay.setText(list.get(position).get("duan")+"");//延时
        viewHolder.X_item_errorname.setText((String) list.get(position).get("cong_yscs"));//错误
