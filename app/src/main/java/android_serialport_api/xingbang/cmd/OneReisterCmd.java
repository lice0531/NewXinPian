...
public class OneReisterCmd {
     ...
     * @return
     */
    public static byte[] send_10(String addr, String test) {
    ...
    /***
     * 1.3提示有雷管信息自动返回，自动返回雷管ID号 添加检测桥丝前是07//08
     * @param1 addr
     * @param2 data：
     * @return
     */
    public static int getFromXbCommon_Reister_AutoReDenator13_3(String addr, String from) {

        if (from == null) return -1;
        String command = addr + DefCommand.CMD_1_REISTER_3 + "08";//添加检测桥丝前是07//08
        //String realyCmd1 =DefCommand.getCommadHex(command);
...
//				Log.e("自动返回雷管id", "10进制管厂码 facCode: "+Integer.parseInt(facCode, 16) );
     ...
     * @return
     */
    public static From12Reister decode12_newXinPian(String addr, byte[] cmd, String qiaosi_set) {
        //C0001208 FF 00 C5F97817 48 35 6EAAC0  新芯片
        String fromCommad = Utils.bytesToHexFun(cmd);
        String realyCmd1 = DefCommand.decodeCommand(fromCommad);
...
//				Log.e("自动返回雷管id", "10进制管厂码 facCode: "+Integer.parseInt(facCode, 16) );
     ...
     * @return
     */
    public static byte[] send_13(String addr) {
