 ...
 */
@Entity(nameInDb = "denatorHis_Detail_all")
public class DenatorHis_Detail_all {
    ...
    private String name;
    @Generated(hash = 479904188)
    public DenatorHis_Detail_all(Long id, int blastserial, int sithole,
    ...
    @Generated(hash = 1341626905)
    public DenatorHis_Detail_all() {
    }
    public Long getId() {
        return this.id;
    }
