...
public class QuYuDao extends AbstractDao<QuYu, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IsQb = new Property(11, String.class, "isQb", false, "isQb");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, QuYu entity) {
        ...
        String isQb = entity.getIsQb();
        if (isQb != null) {
            stmt.bindString(12, isQb);
        }
    }
    ...
    public QuYu readEntity(Cursor cursor, int offset) {
        QuYu entity = new QuYu( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11) // isQb
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, QuYu entity, int offset) {
        ...
        entity.setIsQb(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
     }
